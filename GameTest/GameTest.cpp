...
void Init()
{
	...
	SpriteManager::GetInstance()->RegisterNewSprite("Shell", ".\\Game\\Resources\\Sprites\\SPR_CFB_Shell.png");
	SpriteManager::GetInstance()->RegisterNewSprite("Title", ".\\Game\\Resources\\Sprites\\CFB_SPR_Title.png");
